...
ActiveRecord::Schema.define(version: 20170924162217) do
  ...
  add_index "favoreites", ["post_id"], name: "index_favoreites_on_post_id", using: :btree
  add_index "favoreites", ["user_id"], name: "index_favoreites_on_user_id", using: :btree
